...
from research.data.processing.load_synth_data import get_yield_surfaces_df
...
if __name__ == '__main__':
    runs = [0,1, 2]
    raw_data_path = f"D:/Work/software/st-bingo/research/data/generate_bigger_iso/"
    ...
    for n in runs:
        ...
        np.savetxt(f"../processed_data/vm_{n}_bingo_format.txt", normal_data)
        np.savetxt(f"../processed_data/vm_{n}_transpose_bingo_format.txt", transposed_data)
