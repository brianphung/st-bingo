...
if __name__ == '__main__':
    ...
    vpsc_checkpoint_path = f"checkpoints/vpsc_fcc_OPENSEASON_BIIIIIIG_Stack_{shotgun_number}"
    if not os.path.exists(vpsc_checkpoint_path):
        os.makedirs(vpsc_checkpoint_path)

    #run hill experiment
    data_path = "/scratch/general/vast/u0674703/bingo_shotgun_FCC/st-bingo/research/data_6x6/processed_data/VPSC_FCC_BINGO.txt"
