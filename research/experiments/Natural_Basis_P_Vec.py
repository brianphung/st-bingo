...
def run_deviatoric_experiment(dataset_path,
    ...
    N_CPUS_TO_USE = processors #CPU_COUNT #floor(CPU_COUNT * 0.9)
...
if __name__ == '__main__':
    ...
    checkpoint_P_sym = '/scratch/general/vast/u0674703/bingo_shotgun_vpsc/checkpoints/vpsc_hcp_OPENSEASON_BIIIIIIG_Stack_40/checkpoint_731.pkl'
    ...
    if 'vpsc_hcp' in problems_to_run:
        vpsc_checkpoint_path = f"checkpoints/vpsc_hcp_vec_{shotgun_number}"
        if not os.path.exists(vpsc_checkpoint_path):
            os.makedirs(vpsc_checkpoint_path)

        #run hill experiment
        data_path = "/uufs/chpc.utah.edu/common/home/u0674703/scv/bingo_shotgun_vpsc/st-bingo/research/data_6x6/processed_data/VPSC_HCP_BINGO.txt"
